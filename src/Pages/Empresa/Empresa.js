        ...
        <Row className=" p-3 jumbotron_container  ">
          <Col sm={12}>
            ...
            <p className="jumbotron_letters text-white ">
              ...
              como pensamiento fundamental creando juguetes seguros para ellos.
              Es en los niños/niñas en que el juguete es un concepto
              imprescindible y en el que toma su máximo valor en el contexto del
              desarrollo humano..
            </p>
            ...
            <p className="jumbotron_letters text-white">
              ...
              ambos en sociedad. Los niños comparten muchas horas con los
              juguetes por eso éstos deben ser capaces de resistir el uso que el
              niño le dará, además de no suponerle un peligro. Megaprice es una
              fábrica que se encuentra comprometida plenamente con los
              requerimientos establecidos en materia de seguridad. Nuestros
              juguetes cuentan con un sistema europeo que no permite que las
              ruedas de los vehículos se desprendan de su eje, logrando a su vez
              que dicho eje permanezca brilloso evitando su opacamiento y
              oxidación. Los mismos también son sometidos a rigurosos análisis y
              ensayos, los cuales son realizados en el laboratorio de la Cámara
              Argentina de la Industria del Juguete, obteniendo luego
              certificados de conformidad emitidos por el INTI (Instituto
              Nacional de Tecnología Industrial). Además de encontrarse todos
              los productos certificados por las normas IRAM correspondientes
